...
our ($Kwds)   = do {
  my $a = {
    ...
    DIAL => {
              ...
              10 => { descr => "Ryuukyuu-ben", id => 10, kw => "rkb" },
    ...
    MISC => {
              ...
              27       => { descr => "onomatopoeic or mimetic word", id => 27, kw => "on-mim" },
    ...
    RINF => {
              ...
              21     => { descr => "old or irregular kana form", id => 21, kw => "oik" },
