...
our ($Kwds)   = do {
  my $a = {
    ...
    LSRC => {
              1 => { descr => "fully describes source word\n", id => 1, kw => "full" },
              2 => { descr => "partially describes source word\n", id => 2, kw => "part" },
              full => 'fix',
              part => 'fix',
            },
    MISC => {
    ...
    SRC  => {
              ...
              3 => { descr => "Entry from the Examples file\n", id => 3, kw => "examples" },
              examples => 'fix',
              jmdict => 'fix',
              jmnedict => 'fix',
            },
  ...
  $a->{LSRC}{full} = $a->{LSRC}{1};
  $a->{LSRC}{part} = $a->{LSRC}{2};
  $a->{MISC}{X} = $a->{MISC}{1};
