...
ALTER TABLE grp DROP CONSTRAINT grp_entr_fkey;
ALTER TABLE grp DROP CONSTRAINT grp_kw_fkey ;
ALTER TABLE sndvol DROP CONSTRAINT sndvol_corp_fkey;
ALTER TABLE sndfile DROP CONSTRAINT sndfile_vol_fkey;
ALTER TABLE snd DROP CONSTRAINT snd_file_fkey;
ALTER TABLE entrsnd DROP CONSTRAINT entrsnd_entr_fkey;
ALTER TABLE entrsnd DROP CONSTRAINT entrsnd_entr_fkey1;
ALTER TABLE rdngsnd DROP CONSTRAINT rdngsnd_entr_fkey;
ALTER TABLE rdngsnd DROP CONSTRAINT rdngsnd_entr_fkey1;
