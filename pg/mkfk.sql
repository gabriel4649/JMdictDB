...
ALTER TABLE freq ADD FOREIGN KEY (entr,kanj) REFERENCES kanj(entr,kanj) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE freq ADD FOREIGN KEY (entr,rdng) REFERENCES rdng(entr,rdng) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE freq ADD FOREIGN KEY (kw) REFERENCES kwfreq(id);
