...
Data = [
    ...
    ('020', u'ぁ',               jdb.KANA|jdb.RX,           True,  False, False, ),
    ('021', u'あ',               jdb.KANA|jdb.RX,           True,  False, False, ),
    ('022', u'ん',               jdb.KANA|jdb.RX,           True,  False, False, ),
    ('023', u'ァ',               jdb.KANA|jdb.RX,           True,  False, False, ),
    ('024', u'ア',               jdb.KANA|jdb.RX,           True,  False, False, ),
    ('025', u'ン',               jdb.KANA|jdb.RX,           True,  False, False, ),
    ('026', u'ー',               jdb.KANA,                  False, True,  False, ),
    ('027', u'一',               jdb.KANJI,                 False, True,  False, ),
    ...
    ('036', u'ヽ',               jdb.KANA,                  False, True,  False, ),
    ('037', u'ヾ',               jdb.KANA,                  False, True,  False, ),
    ('038', u'ゝ',               jdb.KANA,                  False, True,  False, ),
    ('039', u'ゞ',               jdb.KANA,                  False, True,  False, ),
    ...
    ('101', u'ーパ',              jdb.KANA|jdb.RX,           True,  False, False, ),
    ('102', u'スーパー',            jdb.KANA|jdb.RX,           True,  False, False, ),
    ('103', u'会う',              jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('104', u'ＰＣエンジン',          jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('105', u'１０しん',            jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('106', u'スコップ！',           jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('107', u'２ちゃんねる',          jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('108', u'ＫＤＤＩ',            jdb.KANJI,                 False, True,  False, ),
    ('109', u'ＰＣエンジン',          jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('110', u'ｍｉｘｉ',            jdb.KANJI,                 False, True,  False, ),
    ('111', u'しろＭＩＤタワ',         jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('112', u'ＦＣ東京',            jdb.KANJI,                 False, True,  False, ),
    ('113', u'ＳＭＢＣフレンド証券',      jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('114', u'あか組４',            jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('115', u'βカロチン',           jdb.KANA|jdb.RX|jdb.OTHER, False, True,  False, ),
    ('116', u'〆る',              jdb.KSYM|jdb.KANA|jdb.RX,  True,  False, False, ),
    ('117', u'おげんき',            jdb.KANA|jdb.RX,           True,  False, False, ),
    ('118', u'お元気',             jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('119', u'会う',              jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('120', u'アンパックしんひょうきほう',   jdb.KANA|jdb.RX,           True,  False, False, ),
    ('121', u'アンパック１０しんひょうきほう', jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('122', u'インターナショナライゼーション／インターナショナリゼーション',
				jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False  ),
    ('123', u'バタード・チャイルド',      jdb.KANA|jdb.RX,           True,  False, False, ),
    ('124', u'黄葉・こうよう',         jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('125', u'タバコ・モザイク病',       jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ('126', u'原子力安全・保安院',       jdb.KANJI|jdb.KANA|jdb.RX, False, True,  False, ),
    ]
