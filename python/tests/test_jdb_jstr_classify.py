...
Data = [
    ...
    ('044', u'・',               jdb.KANA,                  True,  False, False, ),
    ...
    ('116', u'〆る',             jdb.KSYM|jdb.KANA,         False, True,  False, ),
    ...
    ('121', u'アンパック１０しんひょうきほう', jdb.KANJI|jdb.KANA, False, True,  False, ),
    ('122', u'インターナショナライゼーション／インターナショナリゼーション',
				 jdb.KANJI|jdb.KANA,        False, True,  False  ),
    ('123', u'バタード・チャイルド', jdb.KANA,              True,  False, False, ),
    ('124', u'黄葉・こうよう',   jdb.KANJI|jdb.KANA,        False, True,  False, ),
    ('125', u'タバコ・モザイク病', jdb.KANJI|jdb.KANA,      False, True,  False, ),
    ('126', u'原子力安全・保安院', jdb.KANJI|jdb.KANA,      False, True,  False, ),
    ]
